...
router.put(
  '/event/:eventId', auth.authenticated, validate.eventId,
  validate.addEvent, eventController.modifyEvent
);
...
router.get('/center/:eventId', validate.eventId, eventController.centerEvent);
