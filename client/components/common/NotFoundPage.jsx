  ...
  <div>
    <div>
      <header className="header">
        <nav className="navbar z-depth-2 navbar-expand-lg navbar-dark fixed-top"
          style={{ background: 'white' }}>
          <div className="container">
            <a href="#" className="font-weight-bold navbar-brand"
              style={{ color: '#00695c' }}>Events Manager</a>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav ml-auto nav-flex-icons">
                <li className="nav-item">
                  <a href="#" className="nav-link font-weight-bold waves-effect
                   waves-light" style={{ color: '#00695c' }}>Centers</a>
                </li>
                <li className="nav-item">
                  <a href="#" className="nav-link  font-weight-bold waves-effect
                   waves-light" style={{ color: '#00695c' }}>Events</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className="row">
        ...
        <div className="col-xl-4">
          <img className="img-fluid not-found"
            src="https://static1.squarespace.com/static/51cdafc4e4b09eb676a64e68/t/57a119e3f5e23161e8daf73d/1470175723578/"
            alt=""/>
        </div>
        <div className="col-xl-4">
