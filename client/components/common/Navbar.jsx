    ...
    return (
      <div>
        <header className="header">
          <nav className="navbar z-depth-3 mb-4 navbar-expand-lg navbar-dark fixed-top">
                  ...
                  isAuthenticated ? <ul className="navbar-nav ml-auto nav-flex-icons">
                    <li className="nav-item dropdown">
                      ...
                      <div className="dropdown-menu dropdown-menu-right dropdown-unique" aria-labelledby="navbarDropdownMenuLink">
                        <Link onClick={this.props.logOut} className="font-weight-bold dropdown-item waves-effect btn btn-size waves-light ml-1 text-center" to="/">Log out</Link>
                      </div>
                    </li>
